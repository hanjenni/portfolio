            ...
            <Box className='portfolioBox'>
                <Grid container rowSpacing={2} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    <Grid className='portfolio'>
                        <Item className='item'><img src="https://i.imgur.com/s5dForum.png" alt="Tama the Tamagotchi" />
                            <br></br>
                            <br></br>
                            <a className = 'button'href='https://github.com/hanjenni/tamagotchi'>Github</a> | <a className = 'button' href='https://hanjenni.github.io/tamagotchi/'>Deployment Link</a>
                    ...
                    <Grid className='portfolio' >
                        <Item className='item'><img src="https://i.imgur.com/JuuooU1m.png" alt="Honest Schools" />
                        <br></br>
                        <br></br>
                        <a className = 'button' href='https://github.com/hanjenni/project-2'>Github</a> | <a className = 'button' href='https://warm-escarpment-40704.herokuapp.com/'>Deployment Link</a>
                    ...
                    <Grid className='portfolio'>
                        <Item className='item'><img src="https://i.imgur.com/AbKDDzTm.png" alt="Streamur Lemur" />
                            <br></br>
                            <br></br>
                            <a className = 'button' href='https://github.com/hanjenni/streamer-lemur'>Github</a> | <a className = 'button' href='https://streamerlemur.herokuapp.com/'>Deployment Link</a>
                    ...
                    <Grid className='portfolio'>
                        <Item className='item'><img src="https://i.imgur.com/EZnRzDZm.png" alt="Baby Animals" />
                            <br></br>
                            <br></br>
                            <a className = 'button' href='https://github.com/hanjenni/babyanimals'>Github</a> | <a className = 'button' href='https://baby-animals.herokuapp.com/'>Deployment Link</a>
